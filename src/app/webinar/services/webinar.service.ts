...
export class WebinarService {
  ...
  private upcomingWebinars: Webinar[] = [
    ...
    {
      organization: 'Global Med Edu',
      sponsoredBy: 'Sponsored by MedAccess',
      followers: 4000,
      timeAgo: '1 day ago',
      orgLogo: 'assets/globalmed-logo.png',
      bannerUrl: 'assets/webinar6.jpg',
      credits: '1.8 Credits',
      expiresIn: '6 days',
      title:
        'Global Perspectives on Rare Disease Diagnosis and Early Intervention',
      liveDate: '16 Jan 2025, 4:00 PM',
      keyHighlight: 'Multidisciplinary approaches to early detection',
      likes: 70,
      comments: 30,
      watching: 980,
    },
    {
      organization: 'Cardio World Live',
      sponsoredBy: 'Sponsored by HeartLine',
      followers: 2500,
      timeAgo: '2 days ago',
      orgLogo: 'assets/cardioworld-logo.png',
      bannerUrl: 'assets/webinar7.jpg',
      credits: '2.0 Credits',
      expiresIn: '9 days',
      title: 'Managing Complex Cardiovascular Conditions with New Therapies',
      liveDate: '18 Jan 2025, 5:30 PM',
      keyHighlight: 'Evolving treatment guidelines in cardiology',
      likes: 88,
      comments: 42,
      watching: 1430,
    },
